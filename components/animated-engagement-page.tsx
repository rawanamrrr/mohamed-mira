            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Mira</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">April 23, 2026</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">Up Town Palace - Syria</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">April 23, 2026</span>
                      </div>
