...
export default function MemoryWallSection() {
  ...
  const driveLink = "https://drive.google.com/drive/folders/PASTE_YOUR_MEMORY_WALL_FOLDER_LINK_HERE"
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        <motion.div className="text-center mb-20" variants={fastStaggerContainer}>
          ...
          >
            {language === 'ar' ? 'جدار الذكريات' : 'Memory Wall'}
          </motion.h2>
          <motion.p
          ...
          >
            {language === 'ar'
              ? 'شاركوا أجمل ذكرياتكم معنا'
              : 'Share your favorite memories with us'}
          </motion.p>
        </motion.div>

        <motion.div className="max-w-3xl mx-auto" variants={scaleIn}>
          <motion.div
            ...
            <div className="relative z-10">
              ...
              >
                <div className="bg-white p-6 rounded-2xl shadow-lg mb-6 border-2 border-accent/10">
                  <Image src="/qr-code-img.png" alt="QR Code" width={200} height={200} className="w-[200px] h-[200px]" />
                </div>
                <p className="font-luxury text-lg md:text-xl text-foreground text-center mb-2 font-medium">
                  {language === 'ar' ? 'امسح رمز الـ QR' : 'Scan the QR code'}
                </p>
                <p className="font-luxury text-base text-muted-foreground text-center italic">
                  {language === 'ar' ? 'أو افتح المجلد مباشرة' : 'Or open the folder directly'}
                </p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  {language === 'ar' ? 'افتح المجلد' : 'Open Folder'}
                </Button>
              </motion.div>
            </div>
          </motion.div>
